...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:text-accent hover:bg-amber-400",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-accent hover:bg-accent/80  hover:text-secondary",
        secondary:
          "border border-secondary text-primary hover:text-accent bg-secondary hover:bg-secondary/90",
      ...
      size: {
        ...
        lg: "h-11 rounded-md lg:py-6 py-2 px-8",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
