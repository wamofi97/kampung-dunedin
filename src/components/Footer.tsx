...
const Footer = () => {
  return (
    <footer className="bottom-0 mt-24 flex w-full justify-center border-t bg-emerald-900 text-accent">
      <div className="flex w-full max-w-6xl items-center justify-between gap-6 px-3 py-6 md:px-6">
